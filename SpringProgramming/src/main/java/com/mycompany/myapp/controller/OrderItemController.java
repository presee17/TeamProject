...
public class OrderItemController {
	...
	@RequestMapping("/shoppingmall/orderitem/orderitemlist")
	public String list(int orderNo, @RequestParam(defaultValue = "1") int pageNo, Model model, HttpSession session) {
		...
		return "/shoppingmall/orderitem/orderitemlist";
	}
